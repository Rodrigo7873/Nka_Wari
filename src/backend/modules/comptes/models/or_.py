...
class CompteOr(models.Model):
    ...
    cree_par = models.ForeignKey('auth.User', on_delete=models.CASCADE, related_name='comptes_or', null=True)
    ...
    def __str__(self):
        return f"{self.nom} ({self.cree_par.username}) – {self.poids_grammes} g"